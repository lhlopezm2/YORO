...
rec_TE = list(SeqIO.parse("TEDB.fasta", "fasta"))
rec_non = list(SeqIO.parse("negative.fasta", "fasta"))
...
cont = 45000        # Empieza en el mismo valor donde quedo la vez pasada
idx_initial = 172058    # Empieza en valor impreso y se le suma 1
